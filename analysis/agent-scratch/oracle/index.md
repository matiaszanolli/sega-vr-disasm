...
| Normal-1P durable control validation | tools/libretro-profiling/VRD_PROFILING.md § Normal-1P control validator | VR60_STATUS.md § Current milestone; VR60-007 proves bounded liveness and VR60-008 must prove the full 18,000-frame control; candidate/reference ROMs must match outside the reviewed 8-byte hook delta |
