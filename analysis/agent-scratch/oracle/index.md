...
| analysis/evidence/vr60-q027-cmd3f-transport-gate/README.md | Q-027 bounded COMM0/stock-table `$3F` player-shadow candidate | Exact two-edge park/normalize/publish protocol, fixed mailbox, Q-026-identical player result, interpreter transient/convergence table, uninterrupted DRC corroboration, ineligible diagnostic archive | Candidate PASS pending completed-diff audit; non-promotable and not render/shared-lane/authority/cadence/FPS validation |
