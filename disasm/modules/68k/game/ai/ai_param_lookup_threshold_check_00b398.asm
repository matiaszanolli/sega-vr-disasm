...
;   Same structure as ai_param_lookup_threshold_check_00b36e but larger table (18 vs 12 entries).
;
...
ai_param_lookup_threshold_check_00b398:
...
; --- code: lookup + threshold check ---
        ...
        move.w  ai_param_lookup_threshold_check_00b398(PC,D0.W),D0        ; $00B3C0  D0 = table[D0]
