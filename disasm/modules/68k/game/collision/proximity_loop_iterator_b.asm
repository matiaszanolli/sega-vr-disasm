; ============================================================================
; Proximity Loop Iterator B — advance and repeat object_table_3_proximity_with_animation inner loop
; ROM Range: $003C1A-$003C2A (16 bytes)
; ============================================================================
; Advances A1 by 10 bytes to next object entry, loops back to object_table_3_proximity_with_animation
