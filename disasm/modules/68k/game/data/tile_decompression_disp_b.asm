; ============================================================================
; tile_decompression_disp_b — Tile Decompression Dispatcher B
...
; (long). Entries correspond to tile set IDs used by tile_decompression_disp_a.
;
; Code entry at $001530: Alternate tile decompression dispatcher.
; Same 4-iteration pattern as tile_decompression_disp_a but calls the alternate
