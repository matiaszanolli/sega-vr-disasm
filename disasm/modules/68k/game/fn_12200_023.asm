...
; state dispatcher. The dispatcher calls fn_200_047 for setup, then
...
fn_12200_023_dispatch:
        ...
        dc.l    fn_200_047+$00880000            ; $012A42: → fn_200_047
