...
;   and P2 ($C86E) controllers via fn_12200_032 (camera input handler).
...
;   $00E52C: dma_transfer
;   $0135C4: fn_12200_032 (camera input handler)
...
; --- executable code ---
        ...
        dc.w    $6100,$00A6                     ; $01351C  bsr.w fn_12200_032 ($0135C4)
        move.w  ($FFFFC86E).w,D1                ; $013520  D1 = P2 controller
        dc.w    $6100,$009E                     ; $013524  bsr.w fn_12200_032 ($0135C4)
