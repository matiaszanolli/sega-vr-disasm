; ============================================================================
; Input State Dispatcher (3-Entry Jump Table + Init)
; ROM Range: $00456C-$0045CE (98 bytes)
; ============================================================================
; Category: game
; Purpose: Dispatches via 3-entry longword jump table indexed by
;   input_state ($C825) × 4. State 0: initializes sprite block at
...
;   $C825: input_state (byte)
;   $C826: player_flags (byte)
; ============================================================================

fn_4200_007:
        moveq   #$00,D0                         ; $00456C  clear D0
        move.b  ($FFFFC825).w,D0                ; $00456E  D0 = input_state
...
; --- jump table (3 longword entries) ---
        ...
        dc.l    $0088458A                       ; $00457E  [04] → state 0 handler
