...
; module (fn_c200_009). For frames after 995, it falls through to fn_c200_009
...
;   Frame > 995:  Fall through to fn_c200_009 (countdown update)
;   Frame 1296:   Race starts (handled by fn_c200_009)
;
; MEMORY VARIABLES
; ----------------
...
; --- Check timeline frame counter ---
        ...
        bne.s   fn_c200_009                     ; $00C5BE: $6658 — after 995: update handler
