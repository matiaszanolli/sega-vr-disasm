...
;   State  4 ($C8F4=4):  c200_func_006 — race init phase 1 (flag setup)
;   State  8 ($C8F4=8):  c200_func_007 — race init phase 2 (VDP config)
...
.jump_table:
        ...
        dc.l    c200_func_006 + $00880000       ; $00C672: state 4 → race init phase 1
        dc.l    c200_func_007 + $00880000       ; $00C676: state 8 → race init phase 2
