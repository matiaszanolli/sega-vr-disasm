...
; and an alternate entry at $FFFF9F00. Calls c200_func_018 (fn_c200_048)
...
;
; Entry: D0 = entry offset selector (passed to c200_func_018)
...
; --- Initialize primary entry at $FFFF9000 ---
        ...
        bsr.s   c200_func_018                   ; $00CE04: $611C — full table lookup + field copy
