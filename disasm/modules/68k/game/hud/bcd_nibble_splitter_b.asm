...
; ============================================================================
; Identical logic to bcd_nibble_splitter_a — splits byte in D3 into high and low
; nibbles, rendering each as a digit tile via digit_tile_dma_to_framebuffer_b (framebuffer B
