; ============================================================================
; display_entry_builder — Display Entry Builder (5 Racers)
; ROM Range: $00BEFC-$00BF9E (162 bytes)
; ============================================================================
; Builds 5 display entries at $FF6900 from racer data in RAM table ($EF08)
; and ROM data at $0088C05C (display_list_builder data prefix). Each entry includes
...
; code jumps to display_entry_builder + index×4 to select which A6-relative value
...
; --- main code ----------------------------------------------------------------
        ...
        lea     $0088C05C,A3                    ; $00BF1E  ROM data (display_list_builder prefix)
