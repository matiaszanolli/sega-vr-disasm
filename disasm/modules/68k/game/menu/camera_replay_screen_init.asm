; ============================================================================
; camera_replay_screen_init — Camera/Replay Screen Initialization
; ROM Range: $0126D2-$0129E0 (782 bytes)
; ============================================================================
; Initializes the camera selection/replay viewing screen. Similar structure to
; name_entry_screen_init (name entry init) but with camera-specific setup:
;
; Sequence:
...
.loc_0276:
        ...
        MOVE.W  #$8083,MARS_SYS_INTCTL                ; $01295E
