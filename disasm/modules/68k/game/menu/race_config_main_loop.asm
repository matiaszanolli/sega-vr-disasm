; ============================================================================
; race_config_main_loop — Race Config Main Loop
...
;   4. Handle player 1 input (D-pad, buttons) via car_driver_selection_input_handler
;   5. Handle player 2 input via car_driver_selection_input_handler (if 2P config)
