; ============================================================================
; race_config_screen_init — Race Config Screen Initialization
...
.loc_01B8:
        ...
        ANDI.B  #$FC,MARS_VDP_MODE+1                  ; $013A46
        ORI.B  #$01,MARS_VDP_MODE+1                   ; $013A4E
        MOVE.W  #$8083,MARS_SYS_INTCTL                ; $013A56
