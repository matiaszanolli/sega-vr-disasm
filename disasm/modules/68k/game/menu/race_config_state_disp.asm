; ============================================================================
; race_config_state_disp — Race Config State Dispatcher
...
; handler configures player 1 and player 2 car selection via car_driver_selection_input_handler.
;
