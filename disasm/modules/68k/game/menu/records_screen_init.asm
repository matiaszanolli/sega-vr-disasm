; ============================================================================
; records_screen_init — Records Screen Initialization
; ROM Range: $011D0A-$011F38 (558 bytes)
; ============================================================================
; Initializes the records/results display screen. Similar structure to
; name_entry_screen_init (name entry init) but simpler — no BCD score accumulation
...
records_screen_init:
        ...
        MOVE.W  #$0083,MARS_SYS_INTCTL                ; $011D22
        ANDI.B  #$FC,MARS_VDP_MODE+1                  ; $011D2A
        JSR     $008826C8                       ; $011D32
...
.loc_012E:
        ...
        ANDI.B  #$FC,MARS_VDP_MODE+1                  ; $011EF0
        ORI.B  #$01,MARS_VDP_MODE+1                   ; $011EF8
        MOVE.W  #$8083,MARS_SYS_INTCTL                ; $011F00
