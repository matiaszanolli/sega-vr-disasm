; ============================================================================
; standings_screen_init — Standings Screen Initialization
...
.loc_0010:
        ...
        MOVE.W  #$0083,MARS_SYS_INTCTL                ; $01307C
        ANDI.B  #$FC,MARS_VDP_MODE+1                  ; $013084
        JSR     $008826C8                       ; $01308C
...
.loc_0120:
        ...
        ANDI.B  #$FC,MARS_VDP_MODE+1                  ; $013244
        ORI.B  #$01,MARS_VDP_MODE+1                   ; $01324C
        MOVE.W  #$8083,MARS_SYS_INTCTL                ; $013254
        JSR     $0088205E                       ; $01325C
        JSR     $00882080                       ; $013262
