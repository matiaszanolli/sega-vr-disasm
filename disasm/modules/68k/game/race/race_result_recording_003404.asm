; ============================================================================
; race_result_recording_003404 — Race Result Recording (2-Player)
...
; else → player 2 at $C883). Same timing lookup/compression as race_result_recording_003272.
...
race_result_recording_003404:
        LEA     (-14330).W,A1                   ; $003404
        CMPA.W  #$9000,A0                       ; $003408
        BEQ.S  .player_selected                        ; $00340C
...
.player_selected:
        ...
        BEQ.S  .leaderboard_slot_selected                        ; $003498
        LEA     $00FF6968,A3                    ; $00349A
.leaderboard_slot_selected:
        MOVE.B  #$02,-$0008(A3)                 ; $0034A0
        JSR     $0088B43C                       ; $0034A6
.not_best_time:
        BTST    #5,(-15602).W                   ; $0034AC
        BNE.S  .advance_replay                        ; $0034B2
