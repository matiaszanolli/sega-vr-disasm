; ============================================================================
; race_sprite_table_init — Race Sprite Table Initialization
...
; copies palette entries via word_to_nibble_unpacker (nibble unpacker) in a 5-
