...
render_slot_setup:
        ...
        BEQ.S  .viewport_a_ready                ; $003F38
        TST.W  $00C0(A0)                        ; $003F3A
        BEQ.S  .viewport_a_ready                ; $003F3E
        MOVEQ   #$01,D3                         ; $003F40
        MOVEQ   #$02,D4                         ; $003F42
.viewport_a_ready:
        LEA     $00FF64AC,A1                    ; $003F44
        JSR     .setup_slots(PC)                ; $003F4A
        MOVEQ   #$01,D3                         ; $003F4E
        MOVEQ   #$02,D4                         ; $003F50
        LEA     $00FF6178,A1                    ; $003F52
        BRA.S  .setup_slots                     ; $003F58
        MOVEQ   #$00,D3                         ; $003F5A
        MOVEQ   #$00,D4                         ; $003F5C
        TST.W  $00FF6218                        ; $003F5E
        BEQ.S  .viewport_c_ready                ; $003F64
        TST.W  $00C0(A0)                        ; $003F66
        BEQ.S  .viewport_c_ready                ; $003F6A
        MOVEQ   #$01,D3                         ; $003F6C
        MOVEQ   #$02,D4                         ; $003F6E
.viewport_c_ready:
        LEA     $00FF627C,A1                    ; $003F70
        JSR     .setup_slots(PC)                ; $003F76
        MOVEQ   #$01,D3                         ; $003F7A
        MOVEQ   #$02,D4                         ; $003F7C
        LEA     $00FF63A8,A1                    ; $003F7E
        BRA.S  .setup_slots                     ; $003F84
