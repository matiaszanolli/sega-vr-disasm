; ============================================================================
; vdp_vram_clear_via_dma — VDP VRAM Clear via DMA
...
.clear_cram_loop:
        ...
        DBRA    D7,.clear_cram_loop                    ; $000618
...
.clear_sprite_loop:
        ...
        DBRA    D7,.clear_sprite_loop                    ; $000634
