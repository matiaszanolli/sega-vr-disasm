...
; PURPOSE
; -------
; Contains two inline data tables used by scene_phase_timer_setup (fn_c200_031) for
...
; causing scene_phase_timer_setup to be called again to set up the next phase.
;
; DATA TABLES (accessed by fn_c200_031 via PC-relative indexed addressing)
; -----------------------------------------------------------------------
;   scene_phase_timer_tick_data_tables (10 bytes):
...
; --- Data tables (accessed by scene_phase_timer_setup via PC-relative indexed read) ---
scene_phase_timer_tick_data_tables:
