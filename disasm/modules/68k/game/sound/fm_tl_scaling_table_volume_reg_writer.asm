...
fm_tl_scaling_table_volume_reg_writer:
        ...
        BEQ.S  .instr_ptr_ready                 ; $03136E
        MOVEA.L $0020(A5),A1                    ; $031370
        TST.B  $000E(A6)                        ; $031374
        BMI.S  .instr_ptr_ready                 ; $031378
        MOVEA.L $0034(A6),A1                    ; $03137A
.instr_ptr_ready:
        SUBQ.W  #1,D0                           ; $03137E
        BMI.S  .skip_advance                    ; $031380
        MOVE.W  #$0019,D1                       ; $031382
.advance_to_instrument:
        ADDA.W  D1,A1                           ; $031386
        DBRA    D0,.advance_to_instrument        ; $031388
.skip_advance:
...
.operator_loop:
        ...
        MOVE.B  (A1)+,D1                        ; $0313AE
        LSR.B  #1,D4                            ; $0313B0
        BCC.S  .skip_volume_add                 ; $0313B2
        ADD.B   D3,D1                           ; $0313B4
        BCS.S  .skip_volume_add                 ; $0313B6
        jsr     fm_write_cond(pc)       ; $4EBA $F912
.skip_volume_add:
        DBRA    D5,.operator_loop                ; $0313BC
