; ============================================================================
; sequence_data_word_decoder — Sequence Data Word Decoder
; ROM Range: $00B3CE-$00B40E (64 bytes)
; Decodes 3 bytes from sequence stream (A1) into word-sized output (A2).
; Same lookup tables as sequence_data_byte_decoder ($00899884 and $0089980C). Reads
