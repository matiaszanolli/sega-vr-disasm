; ============================================================================
; object_state_assignment_00837a — Object State Assignment — Less-Than Case
; ROM Range: $00837A-$00838A (16 bytes)
; Less-than handler for the three-way comparison (three_way_value_comparison_router). Copies
