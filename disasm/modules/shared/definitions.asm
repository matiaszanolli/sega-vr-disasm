...
COMM2_LO            equ $A15125        ; COMM2 low byte  (B-004 v7: D0/2 words/row — COMM2_HI stays $00)
COMM3_HI            equ $A15126        ; COMM3 high byte (B-004 v7: D1 height, overwrites A0 top byte)
COMM6_HI            equ $A1512C        ; COMM6 high byte (B-004: formerly D1 height)
COMM6_LO            equ $A1512D        ; COMM6 low byte  (B-004: formerly D0/2 words/row)
