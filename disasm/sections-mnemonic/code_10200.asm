...
; ----------------------------------------------------------------------------
; name_input_handler ($010838) - Grid navigation input
; ----------------------------------------------------------------------------
name_input_handler:
...
loc_0110CA:
        ...
        ORI.B  #$00,D0                          ; $01111E
; ----------------------------------------------------------------------------
; name_entry_main ($011122) - Name entry dispatcher
; ----------------------------------------------------------------------------
name_entry_main:
        JSR     $00882080                       ; $011122
        ...
        JSR     $00882080                       ; $011166
; ----------------------------------------------------------------------------
; name_entry_sub ($01116C) - Sub-state handler
; ----------------------------------------------------------------------------
name_entry_sub:
...
loc_0118D4:
; ----------------------------------------------------------------------------
; time_digit_render ($0118D4) - Time display digit render (3 calls)
; ----------------------------------------------------------------------------
time_digit_render:
        MOVE.B  (A2)+,D3                        ; $0118D4
...
loc_011942:
; ----------------------------------------------------------------------------
; name_digit_render ($011942) - Name entry digit render (3 calls)
; ----------------------------------------------------------------------------
name_digit_render:
