...
loc_0302EE:
; ----------------------------------------------------------------------------
; fm_sequence_process ($0302EE) - FM sound sequence processor
; ----------------------------------------------------------------------------
fm_sequence_process:
        MOVEQ   #$00,D6                         ; $0302EE
...
loc_030C8A:
; ----------------------------------------------------------------------------
; fm_init_channel ($030C8A) - FM channel init (5 calls)
; ----------------------------------------------------------------------------
fm_init_channel:
        BTST    #4,(A5)                         ; $030C8A
...
loc_030CA2:
; ----------------------------------------------------------------------------
; fm_conditional_write ($030CA2) - Conditional FM write (7 calls)
; ----------------------------------------------------------------------------
fm_conditional_write:
        BTST    #2,(A5)                         ; $030CA2
...
loc_030CBA:
; ----------------------------------------------------------------------------
; fm_write_wrapper ($030CBA) - FM write with bus release (8 calls)
; ----------------------------------------------------------------------------
fm_write_wrapper:
...
loc_030CCC:
; ----------------------------------------------------------------------------
; fm_write_conditional ($030CCC) - Conditional FM register write (13 calls)
; ----------------------------------------------------------------------------
fm_write_conditional:
        BTST    #2,$0001(A5)                    ; $030CCC
        BNE.S  loc_030CF4                       ; $030CD2
        ADD.B  $0001(A5),D0                     ; $030CD4
loc_030CD8:
; ----------------------------------------------------------------------------
; fm_write_port0 ($030CD8) - FM chip register write (9 calls)
; ----------------------------------------------------------------------------
fm_write_port0:
...
loc_030D1C:
; ----------------------------------------------------------------------------
; z80_bus_request ($030D1C) - Z80 bus request + wait (13 calls)
; ----------------------------------------------------------------------------
z80_bus_request:
...
loc_030DF4:
; ----------------------------------------------------------------------------
; z80_dac_write ($030DF4) - Z80 bus request + DAC write
; ----------------------------------------------------------------------------
z80_dac_write:
...
loc_030FB2:
; ----------------------------------------------------------------------------
; fm_set_volume ($030FB2) - FM volume control (5 calls)
; ----------------------------------------------------------------------------
fm_set_volume:
        BTST    #2,(A5)                         ; $030FB2
