...
loc_005878:
        ...
        ADDQ.B  #8,-(A4)                        ; $00589E
        DC.W    $0088                           ; $0058A0
        MOVEM.W #$09AE,D0/D3/D7                 ; $0058A2
        DC.W    $0088                           ; $0058A8
        MOVE.W  (A0)+,-$78(A5,D0.W)             ; $0058AA
...
loc_0059D8:
        ...
        SLT     -(A0)                           ; $0059DA
        DC.W    $0088                           ; $0059DC
        BHI.S  loc_005972                       ; $0059DE
        DC.W    $0088                           ; $0059E0
        BLS.S  loc_005978                       ; $0059E2
        DC.W    $0088                           ; $0059E4
        BLS.S  loc_005A22                       ; $0059E6
        DC.W    $0088                           ; $0059E8
