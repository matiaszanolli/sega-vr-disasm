...
; ----------------------------------------------------------------------------
; state_mgmt_entry ($008200) - State management entry
; ----------------------------------------------------------------------------
state_mgmt_entry:
        AND.L  -(A4),D4                         ; $008200
...
loc_008254:
        ...
        OR.B   D4,D0                            ; $00825A
; ----------------------------------------------------------------------------
; time_compare_display ($00825C) - Time comparison display
; ----------------------------------------------------------------------------
...
loc_0082E6:
        ...
        RTS                                     ; $0082F8
; ----------------------------------------------------------------------------
; result_comparison ($0082FA) - Race result comparison
; ----------------------------------------------------------------------------
result_comparison:
...
loc_00839A:
; ----------------------------------------------------------------------------
; num_to_decimal ($00839A) - Number to decimal conversion
; ----------------------------------------------------------------------------
num_to_decimal:
        MOVE.B  (A4),D1                         ; $00839A
...
loc_0084F4:
; ----------------------------------------------------------------------------
; time_compare_indexed ($0084F4) - Compare time against indexed table value
; ----------------------------------------------------------------------------
time_compare_indexed:
        SUBQ.W  #1,D1                           ; $0084F4
        LSL.W  #2,D1                            ; $0084F6
...
loc_00850E:
; ----------------------------------------------------------------------------
; time_overflow_check ($00850E) - Handle time display overflow (>60min)
; ----------------------------------------------------------------------------
time_overflow_check:
...
loc_008538:
        ...
        RTS                                     ; $008546
; ----------------------------------------------------------------------------
; timer_countdown ($008548) - 8 independent game timers
; ----------------------------------------------------------------------------
timer_countdown:
...
loc_0086C6:
        RTS                                     ; $0086C6
; ----------------------------------------------------------------------------
; state_jump_indexed ($0086C8) - Indexed state jump (9 calls)
; ----------------------------------------------------------------------------
state_jump_indexed:
...
; ----------------------------------------------------------------------------
; state_dispatch_alt ($0086FE) - Alternate state dispatch (6 calls)
; ----------------------------------------------------------------------------
state_dispatch_alt:
...
loc_008F4E:
; ----------------------------------------------------------------------------
; state_dispatch_prep ($008F4E) - State dispatch setup (9 calls)
; ----------------------------------------------------------------------------
state_dispatch_prep:
        ADDI.W  #$4000,D0                       ; $008F4E
loc_008F52:
; ----------------------------------------------------------------------------
; state_dispatch_vdp ($008F52) - VDP state dispatcher (9 calls)
; ----------------------------------------------------------------------------
state_dispatch_vdp:
        MOVEQ   #$00,D1                         ; $008F52
        MOVE.W  D0,D1                           ; $008F54
...
loc_00903A:
        ...
        RTS                                     ; $00903E
; ----------------------------------------------------------------------------
; view_offset_calc ($009040) - Camera/view offset calc (7 calls)
; ----------------------------------------------------------------------------
view_offset_calc:
...
loc_00905E:
        ...
        RTS                                     ; $009062
; ----------------------------------------------------------------------------
; view_bounds_check ($009064) - Camera bounds checking (6 calls)
; ----------------------------------------------------------------------------
view_bounds_check:
...
loc_009180:
        RTS                                     ; $009180
; ----------------------------------------------------------------------------
; input_process ($009182) - Input processing
; ----------------------------------------------------------------------------
input_process:
...
; ----------------------------------------------------------------------------
; timer_update ($009312) - Timer update
; ----------------------------------------------------------------------------
timer_update:
...
loc_0094EE:
        ...
        ORI.B  #$18,D0                          ; $0094F6
; ----------------------------------------------------------------------------
; sound_trigger ($0094FA) - Sound trigger
; ----------------------------------------------------------------------------
sound_trigger:
...
loc_009618:
        ...
        RTS                                     ; $00961C
; ----------------------------------------------------------------------------
; state_machine ($00961E) - State machine dispatch
; ----------------------------------------------------------------------------
state_machine:
...
loc_009686:
        RTS                                     ; $009686
; ----------------------------------------------------------------------------
; timer_process ($009688) - Game timer processing (9 calls)
; ----------------------------------------------------------------------------
timer_process:
...
loc_009800:
        RTS                                     ; $009800
; ----------------------------------------------------------------------------
; game_update ($009802) - Game update loop
; ----------------------------------------------------------------------------
game_update:
...
loc_009B04:
        ...
        RTS                                     ; $009B10
; ----------------------------------------------------------------------------
; movement_calc ($009B12) - Movement calculation
; ----------------------------------------------------------------------------
movement_calc:
...
loc_009B50:
        ...
        RTS                                     ; $009B52
; ----------------------------------------------------------------------------
; physics_calc ($009B54) - Physics calculation
; ----------------------------------------------------------------------------
physics_calc:
        MOVEQ   #-$01,D0                        ; $009B54
...
loc_009C9A:
        ...
        DC.W    $000A                           ; $009CCC
; ----------------------------------------------------------------------------
; math_routine ($009CCE) - Math routine
; ----------------------------------------------------------------------------
math_routine:
        MOVE.L  A0,-(A7)                        ; $009CCE
...
loc_009E64:
        ...
        RTS                                     ; $009E6C
; ----------------------------------------------------------------------------
; obj_proximity_check ($009E6E) - Object proximity comparison (10 calls)
; ----------------------------------------------------------------------------
obj_proximity_check:
...
loc_009EBE:
        RTS                                     ; $009EBE
; ----------------------------------------------------------------------------
; state_jump_table ($009EC0) - State dispatcher via $C8AC (7 calls)
; ----------------------------------------------------------------------------
state_jump_table:
...
; ----------------------------------------------------------------------------
; game_state_handler ($00A144) - Game state handler (5 calls)
; ----------------------------------------------------------------------------
game_state_handler:
...
loc_00A19C:
        ...
        DC.W    $00E0                           ; $00A1FA
; ----------------------------------------------------------------------------
; race_state_read ($00A1FC) - Race state from $C8CA (10 calls)
; ----------------------------------------------------------------------------
race_state_read:
