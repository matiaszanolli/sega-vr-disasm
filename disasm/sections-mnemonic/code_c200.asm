...
; ----------------------------------------------------------------------------
; master_sequencer ($00C200) - Scene flow controller
; ----------------------------------------------------------------------------
master_sequencer:
...
loc_00C662:
; ----------------------------------------------------------------------------
; scene_state_dispatch ($00C662) - Scene state jump table dispatcher
; ----------------------------------------------------------------------------
scene_state_dispatch:
        MOVEQ   #$00,D0                         ; $00C662
...
loc_00C85C:
        ...
        JMP     $0088483E                       ; $00C86A
; ----------------------------------------------------------------------------
; scene_transition ($00C870) - Scene state transition (5 calls)
; ----------------------------------------------------------------------------
scene_transition:
...
loc_00CC06:
; ----------------------------------------------------------------------------
; object_array_init ($00CC06) - Initialize object array from ROM table
; ----------------------------------------------------------------------------
object_array_init:
...
loc_00D1AE:
        ...
        RTS                                     ; $00D1D2
; ----------------------------------------------------------------------------
; sound_init ($00D1D4) - FM chip initialization
; ----------------------------------------------------------------------------
sound_init:
...
loc_00E1BC:
; ----------------------------------------------------------------------------
; sh2_palette_load ($00E1BC) - Load palette via SH2 (9 calls)
; ----------------------------------------------------------------------------
sh2_palette_load:
