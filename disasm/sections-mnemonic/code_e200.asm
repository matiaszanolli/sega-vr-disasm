...
loc_00E22C:
; ----------------------------------------------------------------------------
; sh2_graphics_cmd ($00E22C) - Graphics command to SH2 (14 calls)
; ----------------------------------------------------------------------------
sh2_graphics_cmd:
...
loc_00E2E4:
; ----------------------------------------------------------------------------
; sh2_copy_routine ($00E2E4) - SH2 memory copy (7 calls)
; ----------------------------------------------------------------------------
sh2_copy_routine:
        MOVE.W  D2,D6                           ; $00E2E4
        ADD.W  D0,D6                            ; $00E2E6
...
loc_00E2F0:
; ----------------------------------------------------------------------------
; sh2_load_data ($00E2F0) - Data load via SH2 (10 calls)
; ----------------------------------------------------------------------------
sh2_load_data:
...
loc_00E3B4:
; ----------------------------------------------------------------------------
; sh2_cmd_27 ($00E3B4) - SH2 command $27 submit (21 calls)
; ----------------------------------------------------------------------------
sh2_cmd_27:
...
loc_00E448:
        ...
        RTS                                     ; $00E464
; ----------------------------------------------------------------------------
; text_render ($00E466) - Text/digit rendering
; ----------------------------------------------------------------------------
text_render:
        MOVE.B  (A2)+,D1                        ; $00E466
...
loc_00E52C:
; ----------------------------------------------------------------------------
; dma_transfer ($00E52C) - DMA transfer
; ----------------------------------------------------------------------------
dma_transfer:
...
loc_00E866:
        ...
        DC.W    $7FFF                           ; $00E90A
; ----------------------------------------------------------------------------
; track_select_menu ($00E90C) - Track selection dispatcher
; ----------------------------------------------------------------------------
track_select_menu:
        JSR     $00882080                       ; $00E90C
...
; ----------------------------------------------------------------------------
; menu_input_handler ($00EA0E) - Menu navigation input
; ----------------------------------------------------------------------------
menu_input_handler:
...
loc_00F28E:
        ...
        DC.W    $7FFF                           ; $00F41A
; ----------------------------------------------------------------------------
; options_menu ($00F41C) - Options/difficulty menu
; ----------------------------------------------------------------------------
options_menu:
        JSR     $00882080                       ; $00F41C
...
loc_010110:
        ...
        JSR     $00882080                       ; $010128
; ----------------------------------------------------------------------------
; results_screen ($01012E) - Results/statistics screen
; ----------------------------------------------------------------------------
results_screen:
        ...
        JSR     $00882080                       ; $010148
; ----------------------------------------------------------------------------
; attract_mode ($01014E) - Replay/attract mode
; ----------------------------------------------------------------------------
attract_mode:
