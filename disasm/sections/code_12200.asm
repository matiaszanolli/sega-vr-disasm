...
; ============================================================================
        ...
        include "modules/68k/game/menu/records_viewer_main_loop.asm"
        ...
        include "modules/68k/game/hud/lap_time_digit_renderer.asm"
        include "modules/68k/game/hud/bcd_nibble_splitter.asm"
        include "modules/68k/game/hud/digit_tile_dma.asm"
        include "modules/68k/game/menu/byte_iterator.asm"
        include "modules/68k/game/hud/ascii_character_to_tile_index_mapper_012618.asm"
        include "modules/68k/game/camera/camera_tile_block_send.asm"
        include "modules/68k/game/menu/camera_replay_screen_init.asm"
        ...
        include "modules/68k/game/camera/camera_angle_increment_clamp.asm"
        include "modules/68k/game/camera/camera_angle_decrement_clamp.asm"
        include "modules/68k/game/camera/camera_selection_main_loop.asm"
        ...
        include "modules/68k/game/menu/vdp_tile_fill_with_data_table.asm"
        include "modules/68k/game/menu/sh2_multi_param_command_send.asm"
        include "modules/68k/game/menu/standings_screen_init.asm"
        ...
        include "modules/68k/game/menu/race_config_screen_init.asm"
        include "modules/68k/game/menu/race_config_state_disp.asm"
        include "modules/68k/game/menu/camera_sh2_scene_transition_dual_dma.asm"
        include "modules/68k/game/menu/race_config_main_loop.asm"
