# 32X Development Guide

Practical guidance for developing 32X software. For hardware specifications, see [32x-hardware-manual.md](32x-hardware-manual.md).
...
- **SH2**: `cpu_addr = file_offset + 0x02000000` (for ROM access)

Example: File offset `0x000832` → 68000 address `0x00880832`
...
See [32x-technical-info.md](32x-technical-info.md) for the complete list of 22 documented bugs.
